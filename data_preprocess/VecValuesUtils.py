...
def cal_vecvalues_tail(mongo_train_user_collection, fin_path='../data/train_set.csv',
                       fout_path='../data/vecvalues_tail.csv', stoptime='2014-12-19 00'):
    """
    计算后三维的向量，需要mongodb支持
    :param fin_path:样本集csv路径
    :param fout_path:结果路径
    :param stoptime:计算的截止日期
    :return:
    """
    ...
    for line in fin:
        ...
        behavior_rate = cal_useritem_behavior_rate(mongo_train_user_collection, user_id, stoptime_str=stoptime)
